    	...
    	<script src="../../js/bootstrap.js"></script>
			...
			<body style="background-color: SeaGreen;">
				...
				<?php while($row = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){?>
					<form method="post" enctype="multipart/form-data" action="verifEditParceiros.php" class="editar">
						...
						<div class="row">
						  	<div class="col-3">
								<label for="titulo" class="form-label text-white">Endereço</label>
								<input type="text" class="form-control text-white bg-secondary" value="<?=$row['endereco']?>" name="txtendereco" aria-describedby="titulo">
						    </div>
					    <br/>
						</div>
						<div class="row">
						  	<div class="col-3">
								<label for="titulo" class="form-label text-white">telefone</label>
								<input type="text" class="form-control text-white bg-secondary" value="<?=$row['telefone']?>" name="txttelefone" aria-describedby="titulo">
						    </div>
					    <br/>
						</div>
						<div class="row">
