    ...
    <div class="col-lg-8">
      <div class="row  justify-content-md-center container" style="background-color: seagreen; height: 100px; text-align: center;">
        <div class="col-md-10">
           ...
           <div style="padding: 40px 0;" ><h3 style="font-weight: bold; padding: 0; border-radius: 0;">VEJA TAMBÉM NOSSO ESTOQUE DE CARRETAS</h3> </div> </div>
        </div>
        <div class="col-md-2">
          <div style="padding: 40px 0;">
          <button type="button" onclick="location.href='?secao=carretas';" class="btn btn-outline-light" >Ver Carretas</button>
        </div>
        </div>
      </div>
    </div>
